...
if (bot1Attack > bot2Attack){
    ...
    console.log('bot 1 and 2 have the same attack power')
}

if (bot1Health <= bot2Health){
...
if (threat === true){
    console.log('bot2 will continue attacking bot 1')
} else {
...
while(threat){
    ...
    bot1Health -= (bot2Attack - bot1Defense)
    console.log(`bot 2 attacks bot 1's health is now ${bot1Health}`)
    attacks++
    if(bot2Health <0){
        bot2Health = 0
